package org.example.devquizbatch.queue;
...
public class QuizDtoFromResponseQueueTest {
    ...
    void Queue_크기_테스트() {
        ...
        QuizDtoFromResponseQueue.add(QuizDtoConverter.toQuizDtosFromResponses(
                springData, CategoryTitle.SPRING));
        QuizDtoFromResponseQueue.add(QuizDtoConverter.toQuizDtosFromResponses(
        ...
        assertThat(quizDtoFromResponseList1.size()).isEqualTo(5);
        assertThat(quizDtoFromResponseList2.size()).isEqualTo(5);
        assertThat(quizDtoFromResponseList3.size()).isEqualTo(5);
    }
}
